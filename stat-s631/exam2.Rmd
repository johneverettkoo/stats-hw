...
`"non-echolocating birds"`. But since they are both significantly different 
...
Since we have no reason to believe that the residuals are heteroskedastic, we 
will just use the OLS estimators. 

CI for $\beta_1$  $(0.740, 0.877)$
