...
pred.posterior.df <- plyr::ldply(n.0.vector, function(n.0) {
  y.a.tilde <- rnbinom(n, a.a + sum(y.a), mu = a.b + n.a)
  y.b.tilde <- rnbinom(n, 12 * n.0 + sum(y.b), mu = n.0 + n.b)
...
Similar to above, the probability goes to 0 as we become more and more sure 
that $\theta_B > \theta_A$.
