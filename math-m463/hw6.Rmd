...
$P(RBB) = \frac{2}{7} \frac{5}{6} \frac{4}{5} = \boxed{\frac{4}{21}}$

## Part d

We can just sum up our answers from parts (a), (b), and (c):
$P(\text{third is } B) = \frac{4 + 1 + 4}{21} = \boxed{\frac{2}{7}}$
...
all possibilities have the same probability $p^3 q^6$ and the first six can be 
ordered however. Then there are $\binom{7}{1}$ possibilities. So 
$P(\text{2nd and 3rd outs are made by 8th and 9th players})$ 
$= \binom{7}{1} 0.6^3 0.4^4 \approx \boxed{6.193 \times 10^{-3}}$ We can also 
