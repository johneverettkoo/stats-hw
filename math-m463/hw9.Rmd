...
$$= \bigg(-\frac{x^2}{\lambda} e^{-\lambda x} \bigg|_0^\infty + 
\frac{2}{\lambda} \int_0^\infty x e^{-\lambda x} dx \bigg)$$
$$= \frac{2}{\lambda} \int_0^\infty x e^{-\lambda x} dx$$
...
$$= \frac{2}{\lambda} \bigg(-\frac{x}{\lambda} e^{-\lambda x} \bigg|_0^\infty + 
\frac{1}{\lambda} \int_0^\infty e^{-\lambda x} dx \bigg)$$
$$= \frac{2}{\lambda^2} \int_0^\infty e^{-\lambda x} dx$$
$$= -\frac{2}{\lambda^3} (0 - 1)$$
$$= \boxed{\frac{2}{\lambda^3}}$$
