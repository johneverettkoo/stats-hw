...
ggplot() + 
  ...
  geom_segment(aes(x = 0, y = 0, xend = 2, yend = 0), arrow = arrow()) + 
  geom_text(aes(x = 1, y = -epsilon, label = 1)) + 
  geom_curve(aes(x = 2, y = 2, xend = 0, yend = 0), arrow = arrow()) + 
  geom_text(aes(x = .5, y = 1.5, label = 1)) + 
  geom_segment(aes(x = 0, y = 0, xend = 2, yend = 2), arrow = arrow()) + 
  geom_text(aes(x = 1 + epsilon, y = 1 - epsilon, label = 100)) + 
  geom_segment(aes(x = 2, y = 0, xend = 2, yend = 2), arrow = arrow()) + 
  geom_text(aes(x = 2 + epsilon, y = 1, label = 1)) + 
  coord_fixed()
```
